...
import {BusinessListDesignedComponent} from './lists/business-list-designed/business-list-designed.component';
...
// const routes: Routes = routesCommon.concat(routesBengat);
