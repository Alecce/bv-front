...
@Component({
  selector: 'app-jewish-calendar',
  templateUrl: './jewish-calendar.component.html',
  styleUrls: ['./jewish-calendar.component.css'],
  providers: [
    {provide: NgbCalendar, useClass: NgbCalendarHebrew},
    {provide: NgbDatepickerI18n, useClass: NgbDatepickerI18nHebrew}
  ]
})
export class JewishCalendarComponent implements OnInit {
