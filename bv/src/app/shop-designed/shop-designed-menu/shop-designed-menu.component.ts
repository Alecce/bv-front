...
@Component({
  selector: 'app-shop-designed-menu',
  templateUrl: './shop-designed-menu.component.html',
  styleUrls: ['./shop-designed-menu.component.css']
})
export class ShopDesignedMenuComponent implements OnInit {
  tab = 'menu';
