...
import {GrapesWinerySubtableComponent} from './grapes-winery-subtable/grapes-winery-subtable.component';
import {VineyardWinerySubtableComponent} from './vineyard-winery-subtable/vineyard-winery-subtable.component';
import {KashrutWinerySubtableComponent} from './kashrut-winery-subtable/kashrut-winery-subtable.component';
import {QualityWinerySubtableComponent} from './quality-winery-subtable/quality-winery-subtable.component';
import {OrganicWinerySubtableComponent} from './organic-winery-subtable/organic-winery-subtable.component';
import {VeganWinerySubtableComponent} from './vegan-winery-subtable/vegan-winery-subtable.component';
import {BiodynamicWinerySubtableComponent} from './biodynamic-winery-subtable/biodynamic-winery-subtable.component';
...
@Component({
  selector: 'app-admin-winery',
  templateUrl: './admin-winery.component.html',
  styleUrls: ['./admin-winery.component.css']
})
export class AdminWineryComponent extends SuperTabComponent implements OnInit {
  tab = 'winerylist';
  ...
  tableCols = [
    ...
    {variable: 'country_id', name: 'Country', link: false, href: '', hrefId: '', searchFormControlName: 'counrty', default: '', type: 'disabled'},
    ...
    {variable: 'iskashrut', name: 'Is kashrut', link: false, href: '', hrefId: '', searchFormControlName: 'iskashrut', type: 'checkbox', default: false},
    ...
    {variable: 'isquality', name: 'Is quality', link: false, href: '', hrefId: '', searchFormControlName: 'isquality', type: 'checkbox', default: false},
    ...
    {variable: 'isbiodynamic', name: 'Is biodynamic', link: false, href: '', hrefId: '', searchFormControlName: 'isbiodynamic', type: 'checkbox', default: false},
    ...
    {variable: 'isorganic', name: 'Is organic', link: false, href: '', hrefId: '', searchFormControlName: 'isorganic', type: 'checkbox', default: false},
    ...
    {variable: 'isvegan', name: 'Is vegan', link: false, href: '', hrefId: '', searchFormControlName: 'isvegan', type: 'checkbox', default: false},
    ...
    {variable: 'imageData', name: 'Image', link: false, href: '', hrefId: '', searchFormControlName: 'imageData', type: 'image',
      ...
      component: ImageSubtableComponent, imagePath: environment.wineryImageStore},
    {variable: 'emblemData', name: 'Emblem', link: false, href: '', hrefId: '', searchFormControlName: 'emblemData', type: 'image',
      default: {
        id: 'newRow',
        emblemData: {
          old: false,
      ...
      component: ImageSubtableComponent, imagePath: environment.wineryEmblemImageStore},
  ];


  storage = 'wineries';
  storageEmblem = 'winery-emblem';
  lists = {
    language: [],
    country_id: [
    ],
