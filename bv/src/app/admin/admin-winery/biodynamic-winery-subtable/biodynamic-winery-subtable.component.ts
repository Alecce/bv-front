...
@Component({
  selector: 'app-biodynamic-winery-subtable',
  templateUrl: './biodynamic-winery-subtable.component.html',
  styleUrls: ['./biodynamic-winery-subtable.component.css']
})
export class BiodynamicWinerySubtableComponent implements OnInit, AfterViewInit {
  ...
  constructor(private activatedroute: ActivatedRoute,
              ...
              public dialogRef: MatDialogRef<BiodynamicWinerySubtableComponent>,
  ...
  ngAfterViewInit(): void {
    ...
    this.downloadedData.subscribe(fatherData => {
      ...
      if (fatherData) {
        this.listBiodynamic.setData(fatherData);
      }
    });
  }
