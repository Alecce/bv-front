...
@Component({
  selector: 'app-organic-winery-subtable',
  templateUrl: './organic-winery-subtable.component.html',
  styleUrls: ['./organic-winery-subtable.component.css']
})
export class OrganicWinerySubtableComponent implements OnInit, AfterViewInit {
  ...
  constructor(private activatedroute: ActivatedRoute,
              ...
              public dialogRef: MatDialogRef<OrganicWinerySubtableComponent>,
  ...
  ngAfterViewInit(): void {
    ...
    this.downloadedData.subscribe(fatherData => {
      ...
      if (fatherData) {
        this.listOrganic.setData(fatherData);
      }
    });
  }
