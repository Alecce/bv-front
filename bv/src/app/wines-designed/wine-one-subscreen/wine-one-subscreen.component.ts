...
@Component({
  selector: 'app-wine-one-subscreen',
  templateUrl: './wine-one-subscreen.component.html',
  styleUrls: ['./wine-one-subscreen.component.css']
})
export class WineOneSubscreenComponent implements OnInit, AfterViewInit {
...
// @ts-ignore
  ...
  constructor(private service: RequestsService,
              ...
              public dialogRef: MatDialogRef<WineOneSubscreenComponent>,
